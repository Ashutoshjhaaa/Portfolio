...
// =============================================
const FORM_CONFIG = {
  endpoint: "https://formspree.io/f/xnjglgja",
...
const Contact = () => {
  ...
  return (
    <section id="contact" className="liquid-glass rounded-2xl overflow-hidden">
      <div className="flex items-center p-4 border-b border-border text-foreground">
