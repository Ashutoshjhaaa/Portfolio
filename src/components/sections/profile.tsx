...
const Profile = () => {
  ...
  return (
    <section className="p-4 liquid-glass rounded-2xl overflow-hidden">
      <div className="flex items-center gap-4">
        {/* Profile Image */}
        <div className="flex-shrink-0 relative">
          <div
            className="w-24 h-24 rounded-2xl overflow-hidden border-4 border-border cursor-pointer duration-200"
